...
def weight_loss(args):
    ...
    elif args.ds.data in ['DrugBank','Enzyme']:
        weight_loss = None
...
# def load_data_case(args):
#     dir_input = (get_original_cwd()+'/case_study/{}'.format(args.ds.train_data))
#     with open(dir_input, "r") as f:
#         data_list = f.read().strip().split('\n')
#     data_list = shuffle_dataset(data_list, args)

#     test_data_dir = (get_original_cwd()+'/case_study/{}'.format(args.ds.test_data))
